...
public class ProductCart {
  ...
  public ProductCart(ProductName name, ProductBrand brand, Picture picture, PublicId publicId) {

    assertFields(name,brand,picture,publicId);

  }


  public void assertFields(ProductName name, ProductBrand brand, Picture picture, PublicId publicId) {
